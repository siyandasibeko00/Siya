...
if investment_calculation == "Investment" or  investment_calculation == "INVESTMENT" or investment_calculation == "investment":
    ...
    if interest == "Simple" or interest == "simple" or interest == "SIMPLE":
        interest_simple = P*(1 + ((r/100)*t))
        print("Total investment (simple):") + print(round(interest_simple,2))
    elif interest == "Compound" or interest == "compound" or interest == "COMPOUND":
        interest_compound = P*math.pow((1+(r/100)),t)
        print("Total investment (compound):") + print(round(interest_compound,2))
...
#One of the three formats to be used for bond repayments to be calculated
    ...
    P = int(input("Initial amount for investment (Present Value):"))
    i = int(input("Interest rate:"))
    n = int(input("Number of months:"))
    bond_repayment = (((i/100)/12) * P)/(1 - (1 + (i/100)/12)**(-n))
    print("Total bond repayments:") + print(round(bond_repayment,2))
